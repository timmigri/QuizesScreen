...
class QuizesViewModel : ObservableObject {
    ...
    func generateTestWidgets() -> [any QuizWidget] {
        ...
        widgets.append(QuizesModel.FillGapsQuestion(id: 0, text: "Заполните{key1}пропуски{key2}в тексте{key3}Какой-то текст дальше...", answers: ["key1": "abc", "key2": "kek", "key3": "lol"]))
